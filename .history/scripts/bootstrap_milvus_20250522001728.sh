...
python "${CUR_DIR}/langchain_web_ingest.py" --urls https://github.com/modelcontextprotocol/python-sdk \
    ...
    --urls https://modelcontextprotocol.io/quickstart/client \
    --urls https://modelcontextprotocol.io/examples \
    --urls https://modelcontextprotocol.io/docs/concepts/architecture \
